...
<iframe src="https://onedrive.live.com/embed?cid=8644A86B4C012FF7&resid=8644A86B4C012FF7%21150&authkey=AIzxBwi-qmtclTY&em=2" width="402" height="327" frameborder="0" scrolling="no"></iframe>
...
- 情報設計の流れ(前半)
    1. 取り組む課題を決定する
        - (前提条件) 世の中でまだ解決されていない「課題」であること
    1. 開発テーマを決定する
        - (前提条件) 「[情報処理](https://ja.wikipedia.org/wiki/%E6%83%85%E5%A0%B1%E5%87%A6%E7%90%86) をともなう [システム](https://ja.wikipedia.org/wiki/%E6%83%85%E5%A0%B1%E3%82%B7%E3%82%B9%E3%83%86%E3%83%A0) の開発」であること
        - 開発テーマ例
            - ソーシャルを利用した駐車場空き状況システム
            - 服のコーディネートを提案してくれるシステム
            - ブロック崩しゲーム
            - 連打ゲーム
            - クイズゲーム
            - VR、ホログラム
...
- (演習)
    - (タスク)
    	- 必要な機能と画面を洗い出す方法
			- 情報モデル定義書で記した情報モデルから情報の状態遷移図を作成する
        	- 情報の状態遷移図から必要な 画面一覧、機能一覧、画面遷移図、画面仕様書 を作成する
    - (成果物)
    	- 「情報の状態遷移図」
...
- プロジェクトマネジメント
    - スケジューリング手法
        ...
        <iframe src="https://onedrive.live.com/embed?cid=8644A86B4C012FF7&resid=8644A86B4C012FF7%21147&authkey=ABeun4ivR30hcxE&em=2" width="402" height="327" frameborder="0" scrolling="no"></iframe>
...
- (演習)
	- (タスク)
   		- プロトタイプ作成
    		...
    		- (参考)
    			- [Fluid手順書](https://dandydot.no-ip.biz/~dot/presen/fluidui/_build/html/index.html)
	- (成果物)
        - 開発ツールを利用し製品を作成
   			- 「画面遷移図」通りに遷移するプロトタイプ
